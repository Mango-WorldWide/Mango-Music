...
def song_data():
...

    {
        ...
        "mp3": "/static/Music/BLACKPINK - BORN PINK/01. Pink Venom.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "Shut Down",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'BLACKPINK').first().id,
        "mp3": "/static/Music/BLACKPINK - BORN PINK/02. Shut Down.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "Typa Girl",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'BLACKPINK').first().id,
        "mp3": "/static/Music/BLACKPINK - BORN PINK/03. Typa Girl.mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "duration": 2.58,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'BLACKPINK').first().id,
        "mp3": "/static/Music/BLACKPINK - BORN PINK/04. Yeah Yeah Yeah.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'BLACKPINK').first().id,
        "mp3": "/static/Music/BLACKPINK - BORN PINK/05. Hard to Love.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'BLACKPINK').first().id,
        "mp3": "/static/Music/BLACKPINK - BORN PINK/06. The Happiest Girl",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'BLACKPINK').first().id,
        "mp3": "/static/Music/BLACKPINK - BORN PINK/07. Tally.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.04,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'BLACKPINK').first().id,
        "mp3": "/static/Music/BLACKPINK - BORN PINK/08. Ready For Love.mp3",
        "lyrics": "Lyrics",
    },
                                    ...
                                    # BRENT FAIYAZ ALBUM
    {
        ...
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/01. VILLAIN'S THEME.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "LOOSE CHANGE",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/02. LOOSE CHANGE.mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/03. GRAVITY (FEAT. TYLER, THE CREATOR).mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/04. HEAL YOUR HEART (INTERLUDE).mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/05. SKIT_ EGOMANIAC.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "ALL MINE",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/06. ALL MINE.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "PRICE OF FAME",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/07. PRICE OF FAME.mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "duration": 3.18,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/08. GHETTO GATSBY (FEAT. ALICIA KEYS).mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/09. WASTING TIME (FEAT. DRAKE & THE NEPTUNES).mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "ROLLING STONE",
        ...
        "duration": 2.42,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/10. ROLLING STONE.mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "duration": 3.18,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/11. FYTB (FEAT. JOONY).mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "SKIT OBLIVION",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/12. SKIT_ OBLIVION.mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/13. DEAD MAN WALKING.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "ADDICTIONS",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/14. ADDICTIONS.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "ROLE MODEL",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/15. ROLE MODEL.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "JACKIE BROWN",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/16. JACKIE BROWN.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "BAD LUCK",
        ...
        "duration": 2.42,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/17. BAD LUCK.mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/18. SKIT_ WAKE UP CALL.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "ANGEL",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Brent Faiyaz').first().id,
        "mp3": "/static/Music/Brent Faiyaz - WASTELAND/19. ANGEL.mp3",
        "lyrics": "Lyrics",
    },
...

    {
        ...
        "mp3": "/static/Music/Gryffin - Alive/01. Intro.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "Alive",
        ...
        "duration": 3.42,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/02. Alive.mp3",
        "lyrics": "Lyrics",
    },
        {
        "title": "Forever",
        ...
        "duration": 3.07,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/03. Forever.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.31,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/04. Lose Your Love.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.25,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/05. Safe With Me.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.36,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/06. Woke Up in Love.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/07. Reckless.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/08. Glitch In The Simulation.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 4.07,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/09. Evergreen.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/10. Scandalous.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/11. Interlude.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/12. Colors.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/13. After You.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.35,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/14. Best Is Yet To Come.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/15. Sometimes You Know.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 2.53,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/16. Caught Up.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.42,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Gryffin').first().id,
        "mp3": "/static/Music/Gryffin - Alive/17. You Were Loved.mp3",
        "lyrics": "Lyrics",
    },
                                    ...
                                    # IMAGINE DRAGONS ALBUM
    {
        ...
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/01 I Dont Know Why.mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "duration": 3.21,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/02 Whatever It Takes.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "Believer",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/03 Believer.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.52,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/04 Walking The Wire.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.51,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/05 Rise Up.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/06 Ill Make It Up To You.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.25,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/07 Yesterday.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/08 Mouth Of The River.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.07,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/09 Thunder.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/10 Start Over.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/11 Dancing In The Dark.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.18,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/12 Levitate.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/13 Not Today.mp3",
        "lyrics": "Lyrics",
    },

    {
        ...
        "duration": 3.10,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Imagine Dragons').first().id,
        "mp3": "/static/Music/Imagine Dragons - Evolve (Deluxe Edition)/14 Believer (Kaskade Remix).mp3",
        "lyrics": "Lyrics",
    },
...

    {
        ...
        "mp3": "/static/Music/Kanye West - Graduation (2007)/01 Good Morning.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "Champion",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/02 Champion.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "Stronger",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/03 Stronger.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "I Wonder",
        ...
        "duration": 4.03,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/04 I Wonder.mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/05 Good Life (feat T-Pain).mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/06 Can't Tell Me Nothing.mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "duration": 3.24,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/07 Barry Bonds (feat Lil' Wayne).mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/08 Drunk and Hot Girls (feat Mos Def).mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "duration": 3.57,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/09 Flashing Lights (feat Dwele).mp3",
        "lyrics": "Lyrics",
    },
    {
        ...
        "duration": 3.47,  # Replace with the actual duration of the song
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/10 Everything I Am (feat DJ Premier).mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "The Glory",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/11 The Glory.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "Homecoming",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/12 Homecoming.mp3",
        "lyrics": "Lyrics",
    },
    {
        "title": "Big Brother",
        ...
        "artist_id": Artist.query.filter(Artist.name == 'Kanye West').first().id,
        "mp3": "/static/Music/Kanye West - Graduation (2007)/13 Big Brother.mp3",
        "lyrics": "Lyrics",
    },
