    ...
    <div className="audio-player">
      <div className="audio-player-track-controls">
        <button
          ...
          className="audio-player-shuffle"
        >
          <i className="fa-solid fa-shuffle" style={{ color: 'rgba(238, 238, 238, 0.2)' }}></i>
        </button>
        <button
          disabled
          style={{
          ...
          className="audio-playeer-back"
        >
          <i className="fa-solid fa-backward" style={{ color: 'rgba(238, 238, 238, 0.2)' }}></i>
        </button>
        <button
          disabled
          style={{
        ...
        >
          <i className="fa fa-play" aria-hidden="true" style={{ color: 'rgba(238, 238, 238, 0.2)' }}></i>
        </button>
        <button
          disabled
          style={{
        ...
        >
          <i className="fa-solid fa-forward" style={{ color: 'rgba(238, 238, 238, 0.2)' }}></i>
        </button>
        <button
          disabled
          style={{
          ...
          className="audio-player-loop"
        >
          <i className="fa-solid fa-repeat" style={{ color: 'rgba(238, 238, 238, 0.2)' }}></i>
        </button>
      </div>
